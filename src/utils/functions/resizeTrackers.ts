...
export let trackElementHeight = (reference:RefObject<HTMLDivElement|HTMLFormElement|HTMLButtonElement>,property:string) =>{
...
export let trackElementWidth = (reference:RefObject<HTMLDivElement|HTMLFormElement|HTMLButtonElement>,property:string) =>{
  if(reference && reference.current ){
    const handleResize = () => {
      if (reference.current?.clientHeight) {
