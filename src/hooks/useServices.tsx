...
function useServices () {
  ...
  const SERVICES = [
    <FlexRow className="w-full h-full justify-end 
      rtl:justify-start">
      <FlexCol className="p-6 basis-2/3 rounded-tl-xl rounded-bl-xl bg-[#d4d4d420]
        md:basis-full md:rounded-xl">
        <FlexRow className='items-center
          md:flex-row-reverse  rtl:flex-row-reverse'>
          <Frame className="p-6 m-6 rounded-full bg-[#D4D4D4]">
            <svg className="c8" width="1em" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" clipRule="evenodd" d="M13.3278 5.54199H6.67184C3.29784 5.54199 1.60984 5.54199 0.661841 6.52899C-0.286159 7.51599 -0.063159 9.03999 0.383841 12.089L0.805841 14.981C1.15584 17.372 1.33084 18.568 2.22784 19.284C3.12584 20 4.44784 20 7.09484 20H12.9048C15.5508 20 16.8748 20 17.7718 19.284C18.6688 18.568 18.8438 17.372 19.1938 14.981L19.6158 12.089C20.0628 9.03999 20.2858 7.51599 19.3378 6.52899C18.3898 5.54199 16.7018 5.54199 13.3278 5.54199ZM12.5808 13.794C13.1398 13.448 13.1398 12.552 12.5808 12.206L9.20984 10.116C8.66684 9.77899 7.99984 10.217 7.99984 10.91V15.09C7.99984 15.783 8.66684 16.22 9.20984 15.884L12.5808 13.794Z" fill="black"/>
    ...
    <FlexRow className="w-full h-full
      md:justify-center rtl:justify-end ">
      <FlexCol className="p-6 basis-2/3 bg-[#d4d4d420] rounded-tr-xl rounded-br-xl
        md:basis-full md:rounded-xl
       ">
        <FlexRow className="justify-end items-center
          ">
          <Text className="fs-25 text-white font-semibold">{t("eventsCoverage")}</Text>
          <Frame className="p-6 m-6 rounded-full bg-[#D4D4D4]">
            <svg className="fs-20" width="1em" height="1em" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
