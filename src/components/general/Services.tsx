  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex flex-col md:grid md:grid-cols-2 md:gap-[6%]">
        <div className="flex justify-end my-[6%] rtl:justify-start ">
        ...
        <div className="flex  my-[6%] rtl:justify-end">
          <div className="flex flex-col basis-2/3 md:basis-full
        ...
        <div className="flex justify-end my-[6%] md:justify-center rtl:justify-start">
        ...
        <div className="flex  my-[6%] md:justify-center rtl:justify-end">
          <div className="flex flex-col basis-2/3 md:basis-full
           p-[5%] bg-[#d4d4d420] rounded-tr-[16px] rounded-br-[16px] md:rounded-[16px]">
            <div className="flex justify-end items-center md:flex-row-reverse rtl:flex-row-reverse">
