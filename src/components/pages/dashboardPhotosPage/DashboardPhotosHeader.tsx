...
interface DashboardPhotoHeader {
  onSearchChange:(e: React.ChangeEvent<HTMLInputElement>) => void
}
const DashboardPhotoHeader = memo( function DashboardPhotosHeader({onSearchChange}:DashboardPhotoHeader) {
  ...
  <div className="flex gap-6  justify-between items-center mb-[2%] mx-[1%] rounded-md p-[1%] rtl:flex-row-reverse ">
    ...
    <div className="flex items-center gap-[10%] pr-[8%]  ">
     ...
     ring-4 ring-[#fafafa42] outline-8 outline-[#fafafa28] outline text-nowrap gap-2 "  to={`addPhoto`} text={t("addPhoto")}  direction={"left"}>
...
export default DashboardPhotoHeader